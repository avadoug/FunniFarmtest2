    ...
    <div className="mx-auto max-w-7xl px-4 py-14 sm:px-6 lg:px-8">
      ...
      <div className="mt-7">
        <FarmNote
          ...
          title="For launch, direct email is the reliable path."
          tone="farm"
        >
          The website contact form stays disabled until a real email or database
          backend is connected. The farm email and phone number are shown so
          customers still have a clear way to reach The Funni Farm.
        </FarmNote>
      </div>
